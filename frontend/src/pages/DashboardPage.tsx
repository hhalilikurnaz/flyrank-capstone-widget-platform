...
import type { DashboardStats, GeoBreakdownEntry, Submission } from "@/lib/types";
...
export function DashboardPage() {
  ...
  if (!stats || !geo || !submissions) return <PageSpinner />;
  ...
  return (
    <div>
      ...
      <div className="mt-6 grid grid-cols-2 gap-6">
        <Card>
          <CardHeader title="Submissions per widget" />
          <div className="p-5">
            <BarList
              items={stats.submissionsPerWidget.map((w) => ({ label: w.title, value: w.count }))}
