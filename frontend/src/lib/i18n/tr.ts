...
export const tr: Dictionary = {
  ...
  auth: {
    ...
    forgotPassword: {
      subtitle: "Şifrenizi sıfırlamanız için bir bağlantı gönderelim.",
      email: "E posta",
      submit: "Sıfırlama bağlantısı gönder",
      submitting: "Gönderiliyor...",
      successTitle: "Gelen kutunuzu kontrol edin",
      successMessage: "Bu e postayla eşleşen bir hesap varsa, bir sıfırlama bağlantısı gönderildi.",
    ...
    resetPassword: {
      ...
      invalidLink: "Bu sıfırlama bağlantısında eksik bilgi var. Yeni bir bağlantı isteyin.",
      backToLogin: "Girişe dön",
    },
  },
};
